    ...
    let html = `<div class="chart-grey-bg">
                <div class="width-90">
                    ...
                    <div class="chart-city-num2">
                        <div class="chart-str2 str1">
                            <span>Телефон</span>
                            <p>${company.directorPhone ? company.directorPhone : 'Нет телефона'}</p>
                        </div>
                        <div class="chart-str2 str2">
                            <span>E-mail</span>
                            <p>${company.emailAddress ? company.emailAddress : 'Нет email'}</p>
                        </div>
                    </div>
                </div>
            </div>
...
for (let i = 0; i < potrebnostis.length; i++) {
    potrebnostiElement.innerHTML += generatePotrebnosiByCity(i, potrebnostis[i], i + 1);
}
